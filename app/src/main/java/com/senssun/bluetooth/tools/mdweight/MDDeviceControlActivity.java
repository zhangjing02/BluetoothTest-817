...
public class MDDeviceControlActivity extends Activity {
    private final static String TAG = MDDeviceControlActivity.class.getSimpleName();
    ...
    private com.senssun.bluetooth.tools.mdweight.MDBluetoothLeService mBluetoothLeService;
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (com.senssun.bluetooth.tools.mdweight.MDBluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                mConnected = true;
                updateConnectionState(R.string.connected);
                invalidateOptionsMenu();
            } else if (com.senssun.bluetooth.tools.mdweight.MDBluetoothLeService.ACTION_GATT_DISCONNECTED.equals(action)) {
                mConnected = false;
...
//                clearUI();
            ...
            } else if (com.senssun.bluetooth.tools.mdweight.MDBluetoothLeService.ACTION_GATT_SERVICES_DISCOVERED.equals(action)) {
                displayGattServices(mBluetoothLeService.getSupportedGattServices());
            } else if (com.senssun.bluetooth.tools.mdweight.MDBluetoothLeService.ACTION_DATA_AVAILABLE.equals(action)) {
                displayData(intent.getStringExtra(com.senssun.bluetooth.tools.mdweight.MDBluetoothLeService.EXTRA_DATA));
            } else if (com.senssun.bluetooth.tools.mdweight.MDBluetoothLeService.ACTION_DATA_RSSI.equals(action)) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_md_device_control);
        mContext = this;
        ...
        Intent gattServiceIntent = new Intent(this, com.senssun.bluetooth.tools.mdweight.MDBluetoothLeService.class);
...
//					sendBuffer[5] = (byte)Integer.parseInt(Integer.toHexString(0 * 16+num),16);
    ...
    private static IntentFilter makeGattUpdateIntentFilter() {
        ...
        intentFilter.addAction(com.senssun.bluetooth.tools.mdweight.MDBluetoothLeService.ACTION_GATT_CONNECTED);
        intentFilter.addAction(com.senssun.bluetooth.tools.mdweight.MDBluetoothLeService.ACTION_GATT_DISCONNECTED);
        intentFilter.addAction(com.senssun.bluetooth.tools.mdweight.MDBluetoothLeService.ACTION_GATT_SERVICES_DISCOVERED);
        intentFilter.addAction(com.senssun.bluetooth.tools.mdweight.MDBluetoothLeService.ACTION_DATA_AVAILABLE);
        intentFilter.addAction(com.senssun.bluetooth.tools.mdweight.MDBluetoothLeService.ACTION_DATA_RSSI);
        return intentFilter;
    }

 ...
 */
public class BluetoothPressureLeService extends Service {
    private final static String TAG = BluetoothPressureLeService.class.getSimpleName();
...
//            Log.i(TAG,"onCharacteristicWrite  status: " + status + ", data:" + Arrays.toString(characteristic.getValue())+" \n data:"+ sb.toString());
    ...
    public class LocalBinder extends Binder {
        BluetoothPressureLeService getService() {
            return BluetoothPressureLeService.this;
        }
    }

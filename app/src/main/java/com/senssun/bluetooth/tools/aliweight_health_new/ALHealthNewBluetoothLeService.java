 ...
 */
public class ALHealthNewBluetoothLeService extends Service {
    private final static String TAG = ALHealthNewBluetoothLeService.class.getSimpleName();
...
//            }
    ...
    public class LocalBinder extends Binder {
        ALHealthNewBluetoothLeService getService() {
            return ALHealthNewBluetoothLeService.this;
        }
    }
